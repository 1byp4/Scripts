...
local library = {
    version = "1",
    title = title or "Titan Hub " .. tostring(math.random(1,366)),
    fps = 0,
    rank = "private"
}
...
function library:Watermark(text)
    ...
    bar.BackgroundColor3 = Color3.fromRGB(255, 115, 115)
...
function library:InitNotifications(text, duration, callback)
    ...
    function Notification:Notify(text, duration, type, callback)
        ...
        elseif type == "information" then
            bar.BackgroundColor3 = Color3.fromRGB(255, 117, 117)
        end
...
function library:Init(key)
    ...
    function TabLibrary:NewTab(title)
        ...
        page.ScrollBarImageColor3 = Color3.fromRGB(255, 115, 115)
        page.Visible = false
        ...
        if TabLibrary.IsFirst then
            page.Visible = true
            tabButton.TextColor3 = Color3.fromRGB(255, 115, 115)
        ...
        tabButton.MouseButton1Click:Connect(function()
            ...
            TweenService:Create(tabButton, TweenTable["tab_text_colour"], {TextColor3 = Color3.fromRGB(255, 115, 115)}):Play()
        end)
        ...
        function Components:NewButton(text, callback)
            ...
            button.MouseButton1Down:Connect(function()
                TweenService:Create(buttonLabel, TweenTable["hover"], {TextColor3 = Color3.fromRGB(255, 115, 115)}):Play()
            end)
        ...
        function Components:NewTextbox(text, default, place, format, type, autoexec, autoclear, callback)
            ...
            if type == "small" then
                ...
                textBoxValues.Focused:Connect(function()
                    textBoxValues:GetPropertyChangedSignal("Text"):Connect(ResizeTextBox)
                    TweenService:Create(textbox, TweenTable["TextBox"], {BackgroundColor3 = Color3.fromRGB(255, 115, 115)}):Play()
                end)
        ...
        function Components:NewSelector(text, default, list, callback)
            ...
            for i,v in next, list do
                ...
                if optionButton.Text == default then
                    optionButton.TextColor3 = Color3.fromRGB(255, 115, 115)
                ...
                optionButton.MouseButton1Click:Connect(function()
                    ...
                    TweenService:Create(optionButton, TweenTable["selector"], {TextColor3 = Color3.fromRGB(255, 115, 115)}):Play()
        ...
        function Components:NewSlider(text, suffix, compare, compareSign, values, callback)
            ...
            sliderIndicatorGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 115, 115)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(128, 94, 208))}
