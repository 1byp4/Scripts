...
local library = {
	...
	colors = {
		...
		background = Color3.fromRGB(80, 40, 40),
		outerBorder = Color3.fromRGB(60, 15, 15),
		innerBorder = Color3.fromRGB(150, 63, 73),
		topGradient = Color3.fromRGB(200, 0, 0),
		bottomGradient = Color3.fromRGB(50, 0, 0),
